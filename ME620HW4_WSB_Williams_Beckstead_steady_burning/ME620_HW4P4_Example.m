...
%% User Inputs
%##################################################################################
%MODIFY EITHER THE PRESSURE OR TEMPERATURE ARRAY, AND PLOT THE RESULTS

% Uncomment these two inputs to plot for Critical Energy vs Pressure
% P = 5:10;          %Pressure (atm)
% T0 = 300;           % K, desired initial temperature

% Uncomment these two inputs to plot for Critical Energy vs Temperature
% P = 1;          %Pressure (atm)
% T0 = 50:500;           % K, desired initial temperature
...
%% Plotting
%#############################################################################################################
% Uncomment to plot for Critical Energy vs Pressure
% figure(1)
% plot(P, q_crit')
% title('WSB Critical Ignition Energy, T = 300 K, Jim Plotzke');
% ylabel('Critical Energy (J/cm^2)')
% xlabel('Pressure (atm)')

% Uncomment to plot for Critical Energy vs Temperature
% figure(1)
% plot(T0, q_crit')
% title('WSB Critical Ignition Energy, P = 1 atm, Jim Plotzke');
% ylabel('Critical Energy (J/cm^2)')
