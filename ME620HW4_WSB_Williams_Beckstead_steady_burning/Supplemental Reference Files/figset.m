function figset(FontSize,FigLineWidth,FontWeight,MarkerSize, MarkerLineWidth, Xresolution, Yresolution, varargin)
...
legend('boxoff'); % removes box outline from legend
